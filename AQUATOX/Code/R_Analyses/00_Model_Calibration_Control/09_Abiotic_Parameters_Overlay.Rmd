...
# History
01/17/2021- L.Mudge creates script
...
cd <- read_csv("R_Analyses/00_Model_Calibration/Output/01_Compile_Control_Data/control_long.csv") %>%
...
wind <- read_csv("Input/Weather-2013-2019_MesocosmGmbH_Station35km_RInput.csv") %>%
  janitor::clean_names() %>%
