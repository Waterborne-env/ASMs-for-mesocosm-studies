...
results_folder <- "AQUATOX_006_ASM_RingStudy_Mesocosm_Model"
...
setwd("01_Aquatox_Results_Calibration")
...
names(full.grade) <- c("Aquatox Record", 
                       ...
                       "2014: % Criteria met", 
                       "2014: % Within Study Specific Ranges",
                       "2016: % Criteria met", 
                       "2016: % Within Study Specific Ranges",
                       "2018: % Criteria met", 
                       "2018: % Within Study Specific Ranges",
                       "2019: % Criteria met", 
                       "2019: % Within Study Specific Ranges")
...
saveWorkbook(wb, paste0(out.path, "/", run_no, "_Integral_Calibration_Table.xlsx"), overwrite = FALSE)
...
saveWorkbook(wb, paste0(out.path, "/", run_no, "_Waterborne_Calibration_Table1.xlsx"), overwrite = TRUE)
...
conditionalFormatting(wb, sheet = "Macroinvertebrates",
                      ...
                      rule = "<90",
                      style = neg_style)
saveWorkbook(wb, paste0(out.path, "/", run_no,  "_Waterborne_Calibration_TableYN.xlsx"), overwrite = TRUE)
