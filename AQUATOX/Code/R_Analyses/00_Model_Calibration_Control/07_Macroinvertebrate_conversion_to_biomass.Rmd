...
# History
12/08/2021 - L.Mudge creates script
12/10/2021 - Updates to include median values for groups lacking population data.- L.Mudge
12/13/2021 - Updates midpoint data re: email from Jurgen with midpoints for the regression lines.- L.Mudge
12/16/2021 - Creates output for Waterborne that has conversion documentation (equations, units, etc.)- L.Mudge
01/06/2022 - Updates biomass calculations to provide 1 value per group- L.Mudge
01/24/2022 - Reruns with updated units in the 'SpeciesList_ControlData_v_Aquatox.xlsx' source file.- L.Mudge
02/04/2022 - Added chunk that saves the conversion factors - L.Mudge
03/02/2022 - Updates to include conversion for leeches (Hirudinea). Includes re-saving all outputs.- L.Mudge
# Setup
```{r setup}
library(tidyverse)
library(openxlsx)
